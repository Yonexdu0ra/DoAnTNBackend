...
export const EVENTS = {
    ...
    ATTENDANCE_QR_CODE_BY_JOB: (jobId) => `ATTENDANCE_QR_CODE_BY_JOB:${jobId}`,
    ...
    // Employee user-specific subscriptions
    EMPLOYEE_LEAVE_STATUS: (userId) => `EMPLOYEE_LEAVE_STATUS:${userId}`,
    EMPLOYEE_OVERTIME_STATUS: (userId) => `EMPLOYEE_OVERTIME_STATUS:${userId}`,
    EMPLOYEE_ATTENDANCE_STATUS: (userId) => `EMPLOYEE_ATTENDANCE_STATUS:${userId}`,
}
